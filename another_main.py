...
while True:         
    ...
    parser.print_blocks(ut.group_in_blocks(c_cipher, 4))
    print("The translation: ")
    parser.print_blocks(ut.group_in_blocks(en.translate(c_cipher, final_dict, 1), 4))
    print("Final dict is regular: " ,en.final_dict_is_regular(final_dict))
    ...
    while using != "yes" and using != "discard" and using!="exit" and t <= len(analysis_dict[ngram][citext])-1:
        ...
        print("The translation: ")
        parser.print_blocks(ut.group_in_blocks(en.translate(c_cipher, final_dict_cp, 1), 4))
        print(translation)
        t+=1
        using = input("Use this? (yes/no/discard/exit)")
    ...
    if using == "exit": 
        print("Solution: ")
        print(ut.group_in_blocks(en.translate(cipher, final_dict, 1), 4))
        print("\n")
        print(final_dict)
        break